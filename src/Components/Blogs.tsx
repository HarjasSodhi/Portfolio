...
function Blogs() {
    ...
    return (
        <div ref={ref} className={`flex flex-col md:gap-0 gap-10 pt-8 xl:px-10 mt-10 opacity-0 ${inView ? 'animate-[fadeintranslatebottom_0.8s_ease_0.7s_forwards]' : ""}`} id='blogs'>
