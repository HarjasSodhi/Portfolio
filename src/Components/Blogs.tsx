...
function Blogs() {
    ...
    return (
        <div ref={ref} className={`min-h-screen flex flex-col md:gap-0 gap-10 pt-8 xl:px-10 mt-10 opacity-0 ${inView ? 'animate-[fadeintranslatebottom_0.5s_ease_0.5s_forwards]' : ""}`} id='blogs'>
            ...
            <div ref={ref2} className={`grow grid place-content-center lg:grid-cols-2 grid-cols-1 gap-5 opacity-0 ${inView2 ? 'animate-[fadeintranslatebottom_0.5s_ease_1s_forwards]' : ""}`}>
                {
                    data.map(el => {
