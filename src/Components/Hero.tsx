...
function Hero() {
    return (
        <div className='text-white w-full pt-16 h-full' >
            ...
            <div className='mt-2 mb-14 w-full xl:w-1/2 text-[#8892b0]'>I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences. Currently, I’m pursuing my undergrad in <span className='text-[#64ffda]'>Computer Science Engineering</span> and looking for opputunities in <span className='text-[#64ffda]'>Software  Development</span>.</div>
