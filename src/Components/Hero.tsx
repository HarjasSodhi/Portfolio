...
function Hero() {
    ...
    return (
        <div ref={ref} className={`min-h-screen text-white pt-16`} >
            ...
            <div className={`mt-4 mb-14 w-full xl:w-1/2 text-[#8892b0] ${inView ? 'animate-[fadeintranslatebottom_0.5s_ease_4.2s_forwards]' : ""} opacity-0`}>I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences. Currently, I’m pursuing my undergrad in <span className='text-[#64ffda] un'>Computer Science Engineering</span> and looking for opportunities in <span className='un text-[#64ffda]'>Software  Development</span>.</div>
