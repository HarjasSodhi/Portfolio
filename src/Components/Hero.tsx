...
function Hero() {
    ...
    return (
        <div ref={ref} className={`min-h-screen text-white pt-16`} >
            <div className={`${inView ? 'animate-[fadeintranslatebottom_0.5s_ease_2.7s_forwards]' : ""} opacity-0 text-[#64ffda] tracking-widest`}>Hi, my name is</div>
