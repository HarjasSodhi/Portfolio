...
function Nav() {
    ...
    return (
        <div ref={navRef} className='transform translate-y-none transition ease duration-500 sticky w-full top-0 left-0 z-10 flex justify-between items-center bg-[#0a192f] text-white text-sm shadow-black'>
